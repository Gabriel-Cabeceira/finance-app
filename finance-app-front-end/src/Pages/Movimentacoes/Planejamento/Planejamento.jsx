...
import { Divisor, LoadContainer, Main, Resume } from "./planejamento.styles";
...
export default function Planejamento() {
    ...
    const fetchData = async (date) => {
        try {
            const response = await fetch(`${apiUrl}/api/planning?date=${date}`);
    ...
    const handleSubmit = async (formData) => {
        try {
            const response = await fetch(`${apiUrl}/api/planning`, {
                method: 'POST',
                headers: {
    ...
    return (
        <Container>
            <Divisor>
                <AddButton title="Adicionar Planejamento" onClick={handleOpenModal} />
                <MonthCarousel
